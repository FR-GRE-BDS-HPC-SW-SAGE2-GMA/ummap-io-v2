...
int main(int argc, char ** argv)
{
	...
	char * in = (char*)ummap(size, segment_size, 0, PROT_READ, 0, driver_in, policy_in, "none");
	...
	char * out = (char*)ummap(size, segment_size, 0, PROT_READ|PROT_WRITE, 0, driver_out, policy_out, "none");
